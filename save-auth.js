...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var browser, context, page, path, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                return [4 /*yield*/, page.goto('https://computing-ability-8321.my.salesforce.com', {
            ...
            case 5:
                ...
                return [4 /*yield*/, context.storageState({ path: path })];
            case 6:
                _a.sent();
                console.log("\u2705 Saved authentication state to ".concat(path));
